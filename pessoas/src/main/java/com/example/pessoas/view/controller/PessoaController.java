package com.example.pessoas.view.controller;
...
import com.example.pessoas.view.model.PessoaModeloRequest;
import com.example.pessoas.view.model.PessoaModeloResponse;
import com.example.pessoas.view.model.PessoaModeloResponseDetalhes;
...
public class PessoaController {
    ...
    @GetMapping(value="/{id}")
    public ResponseEntity<PessoaModeloResponseDetalhes> obterPorId(@PathVariable String id) {
